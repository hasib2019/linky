@extends('frontend.layouts.custom')
        ...
        <div class="main-content">
                                        ...
                                        @foreach ($sliders as $key => $slider)
                                            <div class="carousel-box">
                                                <a class="d-block"
                                                    ...
                                                    <img class="d-block mw-100 img-fit h-180px h-md-320px @if (count($featured_categories) == 0) h-lg-530px @else h-lg-350px @endif"
                            ...
                            @if (count($featured_categories) > 0)
                                <div class="bg-whit mt-4">
                                    <div class="aiz-carousel slick-left arrow-inactive-none arrow-x-0" data-items="6.5"
                                        data-xxl-items="6.5" data-xl-items="4.5" data-lg-items="5" data-md-items="5"
                                        data-sm-items="3" data-xs-items="2" data-arrows="true">
                                                    ...
                                                    <div class="col mb-2">
                                                        <a href="{{ route('product', $product->slug) }}"
                                                            ...
                                                            <div class="row gutters-5 align-items-center"
                                                                ...
                                                                <div class="col-md">
                                                                    <div class="img">
                                                                        <img class="lazyload img-fit h-140px h-lg-90px"
            ...
            @if ($flash_deal != null)
                <section class="mb-2 mb-md-3 mt-2 mt-md-3" id="flash_deal">
                    <div class="container">
                        <div class="rounded-2 overflow-hidden p-3 p-md-2rem @if (get_setting('flash_deal_section_outline') == 1) border @endif"
                            ...
                            <div class="row gutters-16 align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    @endphp
                                    <div class="pr-md-3">
                                        <div class="aiz-carousel gutters-16 arrow-inactive-none arrow-x-0" data-items="5"
                                            data-xxl-items="5" data-xl-items="4" data-lg-items="3" data-md-items="2.5"
                                            data-sm-items="2.3" data-xs-items="1" data-arrows="true" data-dots="false">
                                            @foreach ($flash_deal_products as $key => $flash_deal_product)
                                                <div
                                                    class="carousel-box position-relative has-transition hov-animate-outline">
                                                    @if ($flash_deal_product->product != null && $flash_deal_product->product->published != 0)
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="{{ $product_url }}"
                                                                ...
                                                                <!-- Product name -->
                                                                <h3
                                                                    class="fw-400 fs-13 text-truncate-2 lh-1-4 mb-0 h-40px text-center pt-1 px-1 mt-1">
                                                                    <a href="{{ $product_url }}"
                        ...
                        <div class="position-relative py-5">
                            <div class="text-center text-xl-left position-relative z-5">
                                <div class="d-lg-flex">
                                            ...
                                            <g id="Group_25375" data-name="Group 25375"
                                                ...
                                                <g id="Group_24321" data-name="Group 24321"
                                                    ...
                                                    <g id="Group_24325" data-name="Group 24325">
                                                        <rect id="Rectangle_18578" data-name="Rectangle 18578"
                                                            width="8" height="2" transform="translate(120 5287)"
                                                            fill="var(--{{ get_setting('cupon_text_color') }})" />
                                                        <rect id="Rectangle_18579" data-name="Rectangle 18579"
                                                            width="8" height="2" transform="translate(132 5287)"
                                                            fill="var(--{{ get_setting('cupon_text_color') }})" />
                                                        <rect id="Rectangle_18581" data-name="Rectangle 18581"
                                                            width="8" height="2" transform="translate(144 5287)"
                                                            fill="var(--{{ get_setting('cupon_text_color') }})" />
                                                        <rect id="Rectangle_18580" data-name="Rectangle 18580"
                                                            width="8" height="2" transform="translate(108 5287)"
                                                            fill="var(--{{ get_setting('cupon_text_color') }})" />
                                                    </g>
                                                </g>
                                            </g>
                                    ...
                                    <div class="ml-lg-3">
                                        <h5 class="fs-36 fw-700 text-{{ get_setting('cupon_text_color') }} mb-3">
                                            {{ translate(get_setting('cupon_title')) }}</h5>
                                        <h5 class="fs-20 fw-400 text-{{ get_setting('cupon_text_color') }}">
                                            {{ translate(get_setting('cupon_subtitle')) }}</h5>
                                        <div class="mt-5 pt-5">
                                            <a href="{{ route('coupons.all') }}"
                                                class="btn btn-secondary rounded-2 fs-16 px-4"
                        ...
                        <div class="container">
                            <div class="p-3 p-md-2rem rounded-2 overflow-hidden @if (get_setting('classified_section_outline') == 1) border @endif"
                                ...
                                @php
                                    ...
                                    $classifiedBannerImageSmall = get_setting(
                                        'classified_banner_image_small',
                                        null,
                                        $lang,
                                    );
                                @endphp
                                ...
                                <div class="">
                                    <div class="row gutters-16">
                                        @foreach ($classified_products as $key => $classified_product)
                                            <div class="col-xxl-4 col-md-6 has-transition hov-shadow-out z-1">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ml-2 ml-lg-4">
                                                    ...
                                                    <a href="{{ route('shop.visit', $seller->slug) }}"
                                                        class="visite-btn">
                                                        <span
                                                            class="button-text">{{ ucfirst(translate('Visit Store')) }}</span>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-6 my-3">
                                        <a href="{{ route('products.brand', $brand->slug) }}"
                                            ...
                                            <span class="d-flex flex-column flex-sm-row align-items-center">
                                                ...
                                                <span
                                                    class="text-center text-dark fs-12 fs-md-14 fw-700 mt-2 mt-sm-0 ml-sm-4">
